...
import {
  SyncOutlined, LinkOutlined, ExclamationCircleOutlined,
        ...
        <motion.div variants={SECTION}>
          <Card style={{ borderRadius: 12, marginBottom: 16 }} styles={{ body: { padding: 16 } }}>
            ...
            <div style={{ marginTop: 10, fontSize: 12, color: '#94A3B8' }}>
              由 GitHub Actions 每 {SYNC_INTERVAL_MIN} 分钟自动同步一次
              {isStale && !failed && (
            ...
            {loading ? (
              ...
              <Space direction="vertical" size={12} style={{ width: '100%' }}>
                <div style={{ fontSize: 12, color: '#94A3B8', marginBottom: -4 }}>
                  这些是钉钉里借了、但库存里对不上号的物品。选一件对应的库存物品完成关联后，才能归还。
                </div>
                ...
                {pending.map((rec) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', gap: 12 }}>
                      ...
                      <span style={{ flexShrink: 0, color: '#D97706', fontWeight: 700, fontSize: 22, lineHeight: 1 }}>
                        {rec.quantity}
                    ...
                    <Space style={{ marginTop: 12, width: '100%' }} wrap>
                      <Select
                        showSearch
                        placeholder="选择对应的库存物品"
                        style={{ width: 240 }}
                        value={picked[rec.id]}
                        onChange={(v) => setPicked((prev) => ({ ...prev, [rec.id]: v }))}
